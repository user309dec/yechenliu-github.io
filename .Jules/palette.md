...
## 2024-05-16 - JavaScript Animations vs. Reduced Motion
...
**Action:** Always check `window.matchMedia` for reduced motion preferences before initializing custom JS animations.
