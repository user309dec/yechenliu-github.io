...
## 2024-05-20 - ARIA Labels for Stylistically Punctuated Links
...
**Action:** Add `aria-label` to all bracketed links to provide clean screen reader text while preserving the visual style.
