...
## 2024-05-24 - JS-Driven Animations and Reduced Motion
...
**Action:** Always check `window.matchMedia` for reduced motion in custom JS animations and bypass the animation if true.
